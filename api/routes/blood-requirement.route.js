...
router.post('/got-blood/:id', checkAuth, BloodRequirementController.got_blood_requirement);
...
router.get('/doners/:id', checkAuth, BloodRequirementController.get_accepted_doners);
